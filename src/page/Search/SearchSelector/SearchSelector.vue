  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="(trademark,index) in trademarkList" :key="trademark.tmId" @click="trademarkClick(trademark)">{{ trademark.tmName }}</li>
        </ul>
      </div>
      <div class="ext">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      attrInfo(attr,value){
        this.$emit('attrInfo',attr.attrId,attr.attrName,value)
      }
    }
  }
</script>
